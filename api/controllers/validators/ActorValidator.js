...
const creationValidator = [
    ...
    check('role').exists({ checkNull: true, checkFalsy: true }).isString().withMessage("The role must be a string").trim().notEmpty().withMessage("The role is required").isIn(['ADMINISTRATOR', 'MANAGER', 'EXPLORER']).withMessage("The role must be a valid role").escape(),
...
const putValidator = [
    ...
    check('role').optional().isString().withMessage("The role must be a string").trim().notEmpty().withMessage("If you want to update the role, you must enter a value").isIn(['ADMINISTRATOR', 'MANAGER', 'EXPLORER']).withMessage("The role must be a valid role").escape()
];
